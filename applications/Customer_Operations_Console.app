...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Console for the customer operations team</description>
    ...
    <footerColor>#96dcf3</footerColor>
    <headerColor>#96dcf3</headerColor>
    ...
    <label>Customer Operations Console</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshListRows</listRefreshMethod>
    <logo>ButtonsLogosImages/Purina_Feed_Greatness_logo.gif</logo>
